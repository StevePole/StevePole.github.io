...
function DesignerCtrl($scope, $http, $location, $anchorScroll, Swagger, SwaggerValidate, SwaggerDiff, ApiDesigner, ApiService, Utility, Validators) {
    function init() {
        ...
        id ? (Utility.log("id: " + id), ApiService.getById(id, ApiService.determineLoadType()).then(function(json) {
            vm.setJson(json);
        })["catch"](function(errorThrown) {
    ...
    vm.clearDesigner = function() {
        ...
        return Utility.log("Setting JSON"), json ? (vm.diff = {}, json.envelope || (json.envelope = Swagger.defaultEnvelope), 
