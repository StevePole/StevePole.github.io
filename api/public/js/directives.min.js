...
!function(angular) {
    ...
    function modelDesignController($scope, ApiDesigner, Validators, Swagger, Utility) {
        var vm = this;
        vm.validators = Validators, vm.remove = Utility.remove, vm.arrayUp = Utility.arrayUp, 
        vm.displayTypes = _.keys(Swagger.typesAndFormats), vm.addProperty = function(model) {
            model.properties.push(ApiDesigner.blankProperty());
    ...
    function responseDocsController() {
        var vm = this;
        vm.viewModelDetails = function(models, modelName) {
            return vm.model = models[modelName], vm.path.push(modelName), !1;
        }, vm.viewModelByDepth = function(models, depth) {
            var modelName = vm.path[depth];
            vm.path = vm.path.slice(0, depth), vm.viewModelDetails(models, modelName);
        };
    }
    ...
    function testsDesign() {
        return {
            restrict: "E",
            controller: "TestDesignController",
            controllerAs: "vm",
            templateUrl: "templates/tests-design.html"
        };
    }
    ...
    angular.module("apis-application.directives").directive("testsDesign", testsDesign), 
