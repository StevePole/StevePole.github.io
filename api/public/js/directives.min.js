...
!function(angular) {
    ...
    function ApisDesignController($scope, Swagger, ApiDesigner, Utility, Validators) {
        ...
        var vm = this;
        vm.utility = Utility, vm.validators = Validators, vm.addApi = function() {
    ...
    function responseHeadersDesignController(ApiDesigner) {
        this.addResponseHeader = function(headers) {
    ...
    function TestDesignController(vm, Swagger, SwaggerValidate, ApiService, ApiDesigner, Utility, Validators) {
        var vm = this;
        vm.errors = [], vm.test = {
            method: "GET",
            responseMessage: "200"
        ...
        vm.templates = {
            ...
            var json = angular.copy(json);
            Swagger.deleteEnvelopeModels(json.models), json.envelope.properties = Utility.arrayToMap(json.envelope.properties, "name"), 
            Swagger.postProcess(json), json.apis = Utility.mapToArray(json.apis), vm.errors = SwaggerValidate.validate(json), 
            Utility.log(json), vm.errors.length || ApiService.save(json.basePath, json), $("#api_spec").val(JSON.stringify(json, null, 4));
